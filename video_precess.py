...
def model_process(args, read_path, TmpPicSavePath):
    ...
    for cnt in range(max_cnt):
        ...
        print(read_path + args.f_name.split('.')[0][-4:] + "_frame"+str(i)+".jpg")
...
if __name__ == '__main__':
    ...
    import argparse
    # 必须参数mode、f_nam。使用的测试视频默认存在file_path
    parser = argparse.ArgumentParser()
    parser.add_argument('--f_name', type=str, default='IMG_5402.MOV')
